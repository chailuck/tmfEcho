...
const (
	...
	TAB_NAME_RD_SVOR   = "RD_SVOR"
	TAB_NAME_SDCI      = "CS_SDCI"
	TAB_NAME_HRDW      = "RD_HRDW"
	TAB_NAME_PKGP      = "CS_PKGP"
	TAB_NAME_PGDT      = "CS_PGDT"
	TAB_NAME_PKPL      = "CS_PKPL"
...
var tab_indc = map[string]string{
	...
	TAB_NAME_SDCI:      INDC_PROD_2SUBR,
	TAB_NAME_HRDW:      INDC_PROD,
	TAB_NAME_PKGP:      INDC_PROD,
	TAB_NAME_PGDT:      INDC_PROD,
	TAB_NAME_PKPL:      INDC_PROD,
}
...
func GetTableSuffix(cust_numb string, subr_numb string, tabl_name string, prod_type string, sub_type string, lt log.LogTracing) (string, string, error) {
	...
	if tab_indc[tabl_name] == INDC_1SUBR {

		suffix, err := getSuffixText(subr_numb, tabl_name, 1, lt)
		if err != nil {
			log.AppTraceLog.Error(log.GenErrLog("Cannot find suffix of table: "+tabl_name+"SUBR:"+subr_numb, lt, log.E100009, nil))
