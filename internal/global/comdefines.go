...
const (
	...
	*/
	...
	// JSON TERM DEFINE
	JSON_TERM_EMPTY_STR = "<EMPTY>"
	JSON_TERM_ZERO_STR  = "-9000000"
	JSON_TERM_ZERO_INT  = -9000000
)

/*
var CONF_DEFAULT_FILE = filepath.ToSlash("\\..\\..\\configs\\default.conf")
var CONF_LOCAL_FILE = filepath.ToSlash("\\..\\..\\configs\\local.conf")
var CONF_LOCAL_DEBUG_FILE = filepath.ToSlash("\\..\\..\\configs\\local_debug.conf")
*/
